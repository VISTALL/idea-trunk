...
/**
 * http://java.sun.com/xml/ns/persistence/orm:one-to-one interface.
 * <pre>
 * <h3>Type http://java.sun.com/xml/ns/persistence/orm:one-to-one documentation</h3>
 ...
 * </pre>
 */
public interface OneToOne extends JavaeeDomModelElement {
	...
	/**
	 * Returns the value of the orphan-removal child.
	 * @return the value of the orphan-removal child.
	 */
	@NotNull
	GenericAttributeValue<Boolean> getOrphanRemoval();
