...
/**
 * http://maven.apache.org/POM/4.0.0:DeploymentRepository interface.
 * <pre>
 * <h3>Type http://maven.apache.org/POM/4.0.0:DeploymentRepository documentation</h3>
 * 4.0.0
 * </pre>
 */
public interface DeploymentRepository extends DomElement {

	/**
	 * Returns the value of the uniqueVersion child.
	 * <pre>
	 * <h3>Element http://maven.apache.org/POM/4.0.0:uniqueVersion documentation</h3>
	 * 4.0.0
	 * </pre>
	 * @return the value of the uniqueVersion child.
	 */
	@NotNull
