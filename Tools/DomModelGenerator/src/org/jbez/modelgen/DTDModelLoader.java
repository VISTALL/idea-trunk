...
//  private void loadDTDByXerces(String namespace, File dtdFile, XMLEntityResolver resolver) throws Exception {
//    // TODO
//    XMLGrammarPreparser preparser = new XMLGrammarPreparser();
//    preparser.setEntityResolver(resolver);
//    preparser.registerPreparser(XMLGrammarDescription.XML_DTD, null);
//    final DTDGrammar grammar = (DTDGrammar)preparser.preparseGrammar(XMLGrammarDescription.XML_DTD, new XMLInputSource(null, dtdFile.getAbsolutePath(), null));
...
//    for (int elIdx=grammar.getFirstElementDeclIndex(); grammar.getElementDecl(elIdx, xmlElementDecl); elIdx=grammar.getNextElementDeclIndex(elIdx)) {
//      System.out.println(""+xmlElementDecl.name);
//
//      String typeName = model.toJavaTypeName(xmlElementDecl.name.localpart, namespace);
...
//      }
//      final TypeDesc td = new TypeDesc(xmlElementDecl.name.localpart, namespace, typeName, TypeDesc.TypeEnum.CLASS);
//
//      final XMLContentSpec contentSpec = new XMLContentSpec();
//      grammar.getContentSpec(grammar.getContentSpecIndex(elIdx), contentSpec);
//      boolean any;
...
//
//
//        case XMLContentSpec.CONTENTSPECNODE_CHOICE: break;
//        case XMLContentSpec.CONTENTSPECNODE_LEAF: break;
//        case XMLContentSpec.CONTENTSPECNODE_ONE_OR_MORE: break;
//        case XMLContentSpec.CONTENTSPECNODE_SEQ: break;
//        case XMLContentSpec.CONTENTSPECNODE_ZERO_OR_MORE: break;
//        case XMLContentSpec.CONTENTSPECNODE_ZERO_OR_ONE: break;
//        default:break;
//      }
//      final XMLAttributeDecl xmlAttributeDecl = new XMLAttributeDecl();
//      for (int attrIdx= grammar.getFirstAttributeDeclIndex(elIdx); grammar.getAttributeDecl(attrIdx, xmlAttributeDecl); attrIdx=grammar.getNextAttributeDeclIndex(attrIdx)) {
//        System.out.println("" + xmlElementDecl.name+"."+xmlAttributeDecl.name);
//
//      }
//    }
//
