...
class MoveAttributeInProcessor extends XRPBaseRefactoringProcessor {
    private final XmlAttribute attribute;
    private final String tagName;
    private final Context context;

    MoveAttributeInProcessor(XmlAttribute attribute, String tagName, Context context, boolean previewUsages) {
    ...
    protected UsageViewDescriptor createUsageViewDescriptor(UsageInfo[] usageInfos) {
        return new MoveAttributeInUsageViewDescriptor(attribute, usageInfos);
    }
        ...
        for (XmlTag xmlTag : tagsFound) {
            if (!XMLMutationUtils.isSpecialJSPTag(xmlTag)) {
                ...
                if (foundAttribute != null) {
                    usages.add(new MoveAttributeIn(xmlTag, tagName, attributeName, attributeNamespace));
                }
            }
        }
    }
    ...
    protected String getCommandName() {
        return "Move attribute " + attribute.getName() +"in";
    }
}
