...
public class LoadContextAction extends BaseTaskAction {
  ...
  public void actionPerformed(AnActionEvent e) {
    ...
    infos.addAll(ContainerUtil.map2List(tasks, new Function<LocalTask, ContextHolder>() {
  ...
  private ActionGroup createItem(final ContextHolder holder, final Ref<Boolean> shiftPressed) {
    String text = DateFormatUtil.formatDate(new Date(), holder.getDate());
