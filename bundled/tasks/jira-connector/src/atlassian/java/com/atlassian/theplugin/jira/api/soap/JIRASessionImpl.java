...
public class JIRASessionImpl implements JIRASession {
  ...
  @Nullable
  public String getServerVersion() throws RemoteApiException {
    try {
      RemoteServerInfo remoteServerInfo = service.getServerInfo(token);
      return remoteServerInfo == null ? null : remoteServerInfo.getVersion();
    }
    catch (RemoteException e) {
      throw new RemoteApiException(e.toString(), e);
    }
