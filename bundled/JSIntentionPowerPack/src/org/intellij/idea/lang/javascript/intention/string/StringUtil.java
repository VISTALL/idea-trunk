...
class StringUtil {
    ...
    public static boolean isStringLiteral(JSLiteralExpression expression) {
        ...
        final char firstLiteralChar = value.charAt(0);
        final char lastLiteralChar  = value.charAt(value.length() - 1);

        return ((firstLiteralChar == SIMPLE_QUOTE && lastLiteralChar == SIMPLE_QUOTE) ||
                (firstLiteralChar == DOUBLE_QUOTE && lastLiteralChar == DOUBLE_QUOTE));
    }
