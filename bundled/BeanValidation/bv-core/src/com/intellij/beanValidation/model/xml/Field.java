...
import com.intellij.beanValidation.model.converters.BvFieldNameConverter;
 ...
 * @generated from http://jboss.org/xml/ns/javax/validation/mapping:fieldType interface.
 */
public interface Field extends BvMappingsDomElement {
  /**
  ...
  @NotNull
  @Required
  @Convert(BvFieldNameConverter.class)
