 ...
 */
public class DefaultUmlRenderer extends AbstractColoredNodeCellRenderer {
  GraphBuilder<UmlNode, UmlEdge> myBuilder;

  public DefaultUmlRenderer(@NotNull GraphBuilder<UmlNode, UmlEdge> builder, ModificationTracker modificationTracker) {
  ...
  public void tuneNode(final NodeRealizer realizer, final JPanel wrapper, Point point) {
    ...
    if (umlNode != null) {
      final UmlNodeContainer container = new UmlNodeContainer(umlNode, myBuilder, point);
