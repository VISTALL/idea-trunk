...
package com.intellij.uml.dependency;
 ...
 */
public class ClassDependencyAnalizer {
  private final PsiClass myClass;

  public ClassDependencyAnalizer(PsiClass clazz) {
    myClass = clazz;
  }
  ...
  private static Pair<PsiClass, UmlRelationship> createPair(PsiClass cl, UmlRelationship relationship) {
    return new Pair<PsiClass, UmlRelationship>(cl, relationship);
  }

  public List<Pair<PsiClass, UmlRelationship>> computeUsedClasses() {
    final List<Pair<PsiClass, UmlRelationship>> dependencies = new ArrayList<Pair<PsiClass, UmlRelationship>>();
    JavaRecursiveElementVisitor visitor = new JavaRecursiveElementVisitor() {
      ...
      public void visitNewExpression(PsiNewExpression expression) {
        ...
        if (type != null) {
          ...
          if (psiClass != null) {
            dependencies.add(createPair(psiClass, UmlRelationship.CREATE));
          }
        }
      ...
      public void visitTypeElement(PsiTypeElement typeElement) {
        ...
        if (psiClass != null && !(psiClass instanceof PsiTypeParameter)) {
          if (insideClassObjectAccess) {
            dependencies.add(createPair(psiClass, UmlRelationship.DEPENDENCY));
          } else if (insideField && !insideNew && !insideCollection && !(type instanceof PsiArrayType)) {
            dependencies.add(createPair(psiClass, UmlRelationship.TO_ONE));
          } else if (insideField && !insideNew && insideCollection && !(type instanceof PsiArrayType)) {
            dependencies.add(createPair(psiClass, UmlRelationship.TO_MANY));
          } else {
            dependencies.add(createPair(psiClass, UmlRelationship.DEPENDENCY));
          }
        }
        ...
        if (qualifierExpression != null) {
          ...
          if (psiReference != null) {
            ...
            if (reference instanceof PsiClass) {
              dependencies.add(createPair(((PsiClass)reference), UmlRelationship.DEPENDENCY));
            }
          }
        }
  ...
  public List<Pair<PsiClass, UmlRelationship>> computeUsingClasses() {
    final List<Pair<PsiClass, UmlRelationship>> dependencies = new ArrayList<Pair<PsiClass, UmlRelationship>>();
      ...
      if (referencingClass != null) {
        ...
        if (parentElement != null) {
          if (parentElement instanceof PsiTypeElement) {
            ...
            if (classObject != null) {
              dependencies.add(createPair(referencingClass, UmlRelationship.DEPENDENCY));
            } else {
              ...
              if (field != null) {
                ...
                dependencies.add(createPair(referencingClass, collection ? UmlRelationship.TO_MANY : UmlRelationship.TO_ONE));
              } else {
                dependencies.add(createPair(referencingClass, UmlRelationship.DEPENDENCY));
              }
            }
            ...
            dependencies.add(createPair(referencingClass, UmlRelationship.CREATE));
