 ...
 */
public class ShowHideVCSFilter extends UmlAction {
  public void actionPerformed(AnActionEvent e) {
    final UmlDiagramPresentation presentation = getPresentation(e);
    if (presentation == null) return;

    presentation.setVcsFilterEnabled(!presentation.isVcsFilterEnabled());
  }

  @Override
  public boolean isSelected(AnActionEvent e, GraphBuilder<UmlNode, UmlEdge> b) {
    final UmlDiagramPresentation presentation = getPresentation(e);
    return presentation != null && presentation.isVcsFilterEnabled();
  }
}
