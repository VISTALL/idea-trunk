 ...
 */
public class TurnOnEdgeCreationAction extends UmlAction {
  public boolean isSelected(final AnActionEvent e, GraphBuilder<UmlNode, UmlEdge> b) {
    return UmlUtils.getPresentation(b).isEdgeCreationMode();
  }
  ...
  public void actionPerformed(final AnActionEvent e) {
    ...
    presentation.setEdgeCreationMode(!presentation.isEdgeCreationMode());
