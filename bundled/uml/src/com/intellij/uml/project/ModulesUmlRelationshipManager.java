 ...
 */
public class ModulesUmlRelationshipManager implements UmlRelationshipManager<ModuleItem> {
  private static final UmlCategory[] CATEGORIES = {new UmlCategory("Dependencies", UmlIcons.DEPENDENCY_ICON)};

  @Nullable
  public UmlRelationshipInfo getDependencyInfo(ModuleItem e1, ModuleItem e2, UmlCategory category) {
    return null;
  }
