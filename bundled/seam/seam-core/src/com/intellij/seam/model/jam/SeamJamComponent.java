...
public abstract class SeamJamComponent extends SeamJamComponentBase {
  ...
  public static final JamClassMeta<SeamJamComponent> META = new JamClassMeta<SeamJamComponent>(SeamJamComponent.class)
    .addPomTargetProducer(new PairConsumer<SeamJamComponent, Consumer<PomTarget>>() {
  ...
  private static final JamAnnotationMeta ANNOTATION_META = new JamAnnotationMeta(SeamAnnotationConstants.COMPONENT_ANNOTATION).addAttribute(NAME_VALUE_META);
  ...
  public SeamJamComponent(PsiClass psiClass) {
    myClass = psiClass;
  }
  ...
  protected JamStringAttributeElement<String> getNamedStringAttributeElement() {
    return ANNOTATION_META.getAttribute(myClass, NAME_VALUE_META);
  }

  @NotNull
  public String getDefaultName() {
    return StringUtil.decapitalize(myClass.getName());
  }
  ...
  public SeamJamValidator getValidator() {
    return JamService.getJamService(getProject()).getJamElement(SeamJamValidator.class, getPsiElement());
  }

  @Nullable
  public SeamJamConverter getConverter() {
    return JamService.getJamService(getProject()).getJamElement(SeamJamConverter.class, getPsiElement());
  }

  @NotNull
  public List<SeamJamInjection> getInjections() {
    List<SeamJamInjection> injections = new ArrayList<SeamJamInjection>();
  ...
  public List<SeamJamOutjection> getOutjections() {
    List<SeamJamOutjection> outjections = new ArrayList<SeamJamOutjection>();
  ...
  private PsiRef<PsiClass> getPsiRef() {
    return PsiRef.real(getPsiElement());
  }
  ...
  @NotNull
  public List<? extends SeamJamRaiseEvent> getRaiseEvets() {
    return RAISE_EVENTS_QUERY.findChildren(getPsiRef());
  }

  @NotNull
  public List<? extends SeamJamDataModel> getDataModels() {
    List<SeamJamDataModel> dataModels = new ArrayList<SeamJamDataModel>();
  ...
  public List<SeamJamDataModelSelection> getDataModelSelections() {
    List<SeamJamDataModelSelection> list = new ArrayList<SeamJamDataModelSelection>();
  ...
  public List<SeamJamDataModelSelectionIndex> getDataModelSelectionIndexes() {
    List<SeamJamDataModelSelectionIndex> list = new ArrayList<SeamJamDataModelSelectionIndex>();
  ...
  public SeamJamInstall getInstall() {
    return JamService.getJamService(getProject()).getJamElement(SeamJamInstall.class, getPsiElement());
  }
