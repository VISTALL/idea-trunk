...
public class SeamComponentsExtender extends DomExtender<SeamComponents> {
  private static final Map<Pair<String, String>, Class> myCustomNamespacedComponentsMap =
      new com.intellij.util.containers.HashMap<Pair<String, String>, Class>();
  private static final Map<Pair<String, String>, Pair<String, Class>> myCustomComponentsRegistryMap =
      new com.intellij.util.containers.HashMap<Pair<String, String>, Pair<String, Class>>();

  static {
    myCustomNamespacedComponentsMap
        .put(new Pair<String, String>("entity-home", SeamNamespaceConstants.FRAMEWORK_NAMESPACE), EntityHome.class);
    myCustomNamespacedComponentsMap
        .put(new Pair<String, String>("resource-loader", SeamNamespaceConstants.CORE_NAMESPACE), ResourceLoader.class);

    myCustomComponentsRegistryMap.put(new Pair<String, String>("resource-bundle", SeamNamespaceConstants.CORE_NAMESPACE),
                                      new Pair<String, Class>("org.jboss.seam.core.ResourceBundle", ResourceBundle.class));
  }
  ...
  private static void registerSeamComponent(final PsiClass psiClass, final String namespace, final DomExtensionsRegistrar registrar) {
    ...
    Class aClass = myCustomNamespacedComponentsMap.get(new Pair<String, String>(xmlName, namespace));
  ...
  private static Map<PsiPackage, String> getNamespaceToPackageName(final JavaPsiFacade facade, final Project project) {
    Map<PsiPackage, String> namespaceToPackageName = new HashMap<PsiPackage, String>();
    PsiClass namespaceAnnotationClass = facade.findClass(SeamNonComponentAnnotations.NAMESPACE_ANNOTATION);
    if (namespaceAnnotationClass != null) {
      for (final PsiPackage target : AnnotatedPackagesSearch.search(namespaceAnnotationClass, GlobalSearchScope.allScope(project))) {
