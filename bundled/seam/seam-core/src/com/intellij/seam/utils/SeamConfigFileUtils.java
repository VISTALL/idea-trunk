...
public class SeamConfigFileUtils {
  ...
  public static Set<XmlFile> getConfigurationFiles(Module module) {
    Set<XmlFile> componentsFiles = new HashSet<XmlFile>();
  ...
  public static List<XmlFile> getConfigsFromMetaInf(final Module module) {
    ...
    List<XmlFile> resourceFiles = new ArrayList<XmlFile>();
    for (VirtualFile file : moduleRootManager.getFiles(OrderRootType.CLASSES)) {
