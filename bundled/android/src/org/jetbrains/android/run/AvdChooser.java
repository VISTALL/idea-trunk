...
public class AvdChooser extends DialogWrapper {
  ...
  public AvdChooser(@NotNull final Project project,
    ...
    updateTable();
    if (mustSelect) {
      final ListSelectionModel selectionModel = myAvdTable.getSelectionModel();
      ...
      selectionModel.addListSelectionListener(new ListSelectionListener() {
        public void valueChanged(ListSelectionEvent e) {
          ...
          getOKAction().setEnabled(avd != null && avd.getStatus() == AvdManager.AvdInfo.AvdStatus.OK);
        }
      });
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
      ...
      switch (columnIndex) {
        case 0:
          return info.getName();
        case 1:
          return info.getTarget().getName();
        case 2:
          return info.getTarget().getVersionName();
        case 3:
          return info.getTarget().getVersion().getApiString();
        case 4:
