...
public class AndroidTestRunConfiguration extends AndroidRunConfigurationBase {
  ...
  @NotNull
  @Override
  protected ConsoleView attachConsole(AndroidRunningState state) throws ExecutionException {
    TestConsoleProperties properties = new AndroidTestConsoleProperties(this);
    BaseTestsOutputConsoleView consoleView = SMTestRunnerConnectionUtil
      .attachRunner(state.getProcessHandler(), properties, state.getRunnerSettings(), state.getConfigurationSettings(),
                    "Android.Splitter.Proportion");
