 ...
 */
public class AddAndroidStringResourceAction extends AbstractIntentionAction {
  @NotNull
  ...
  public void invoke(@NotNull final Project project, Editor editor, PsiFile file) throws IncorrectOperationException {
    ...
    String resName = showInputDialog(project, AndroidBundle.message("resource.name"), AndroidBundle.message(
      "add.string.resource.intention.text"),
  ...
  private static PsiExpression createJavaResourceReference(@NotNull Project project,
    ...
    String field = aPackage + ".R." + resType + '.' + resName;
