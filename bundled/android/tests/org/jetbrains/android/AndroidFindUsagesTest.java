...
public class AndroidFindUsagesTest extends AndroidTestCase {
  ...
  private List<UsageInfo> findCodeUsages(String path) throws Throwable {
    Collection<UsageInfo> usages = findElementAtCaret(path);
  ...
  private Collection<UsageInfo> findElementAtCaret(String fileName) throws Throwable {
    String newFilePath = "res/layout/" + fileName;
    myFixture.copyFileToProject(BASE_PATH + fileName, newFilePath);
    return myFixture.testFindUsages(newFilePath);
  }
