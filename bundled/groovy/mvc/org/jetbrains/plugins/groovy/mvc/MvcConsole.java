...
public class MvcConsole implements Disposable {
  ...
  private static final Icon KILL_PROCESS_ICON = IconLoader.findIcon("/debugger/killProcess.png");
  ...
  public MvcConsole(Project project, TextConsoleBuilderFactory consoleBuilderFactory) {
    ...
    myToolWindow = ToolWindowManager.getInstance(myProject).registerToolWindow(getWindowName(), false, ToolWindowAnchor.BOTTOM, this, true);
  ...
  private static class MyProcessInConsole implements ConsoleProcessDescriptor {
    ...
    private List<ProcessListener> myListeners = new SmartList<ProcessListener>();
  ...
  public synchronized ConsoleProcessDescriptor executeProcess(final Module module,
                                          final ProcessBuilder pb,
                                          final @Nullable Runnable onDone,
                                          final boolean closeOnDone,
                                          final String... input) {
  ...
  private void executeProcessImpl(final MyProcessInConsole pic, boolean toFocus) {
    ...
    final Runnable runnable = new Runnable() {
      public void run() {
        ...
        myConsole.print(pb.command().toString(), ConsoleViewContentType.SYSTEM_OUTPUT);
