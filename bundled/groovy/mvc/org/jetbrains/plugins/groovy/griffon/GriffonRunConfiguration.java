...
public class GriffonRunConfiguration extends MvcRunConfiguration {
  ...
  public GriffonRunConfiguration(ConfigurationFactory factory, Project project, String name, String cmdLine) {
    super(name, new RunConfigurationModule(project), factory, GriffonFramework.INSTANCE);
    myFactory = factory;
  ...
  protected ModuleBasedConfiguration createInstance() {
    return new GriffonRunConfiguration(myFactory, getConfigurationModule().getProject(), getName(), cmdLine);
  }
