 ...
 * @author ilyas
 */
public class GenerateDomainClassAction extends AnAction implements DumbAware {
  ...
  public void actionPerformed(final AnActionEvent e) {
    ...
    MvcConsole.getInstance(project).executeProcess(module, pb, new Runnable() {
      public void run() {
        ...
        assert dir != null;
        VirtualFile file = dir.findFileByRelativePath("grails-app/domain/" + name.replace('.', '/') + GrailsUtils.GROOVY_EXTENSION);
        if (file == null) return;
