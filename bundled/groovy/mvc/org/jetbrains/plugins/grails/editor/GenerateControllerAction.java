...
public class GenerateControllerAction extends AnAction implements DumbAware {
  ...
  public void actionPerformed(final AnActionEvent e) {
    ...
    MvcConsole.getInstance(project).executeProcess(module, pb, new Runnable() {
      public void run() {
        ...
        assert dir != null;
        VirtualFile file = dir.findFileByRelativePath("grails-app/controllers/" + name.replace('.', '/') + "Controller.groovy");
        if (file == null)
          return;
