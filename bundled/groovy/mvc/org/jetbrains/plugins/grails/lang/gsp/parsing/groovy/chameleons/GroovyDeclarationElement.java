...
import org.jetbrains.plugins.grails.lang.gsp.parsing.groovy.GspGroovyDeclarationParser;
 ...
 * @author ilyas
 */
public class GroovyDeclarationElement extends ILazyParseableElementType {

  public GroovyDeclarationElement(String debugName) {
  ...
  public ASTNode parseContents(final ASTNode chameleon) {
    ...
    final PsiParser parser = new GspGroovyDeclarationParser();
  ...
  public ASTNode createNode(CharSequence text) {
    return new GrGspDeclarationHolderImpl(text);
  }
}
