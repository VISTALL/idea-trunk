...
public class NewGrailsDomainClassAction extends NewGrailsXXXAction {
  public NewGrailsDomainClassAction() {
    super(GrailsBundle.message("action.Grails.DomainClass.text"),
        GrailsBundle.message("action.Grails.DomainClass.description"),
        GrailsIcons.DOMAIN_CLASS);
  }
  ...
  protected VirtualFile getTargetDirectory(@NotNull Module module) {
    return GrailsUtils.findDomainClassDirectory(module);
  }
