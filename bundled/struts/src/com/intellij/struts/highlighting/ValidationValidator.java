...
public class ValidationValidator extends StrutsValidatorBase {
  ...
  public ValidationValidator(StrutsProjectComponent component) {
    super("Struts Validation Model validator", "Validating Struts Validator model...", component.getValidatorFactory(), ValidatorInspection.class);
  }
