...
public abstract class StrutsValidatorBase extends InspectionValidator {
  private final DomModelFactory myFactory;

  protected StrutsValidatorBase(@NotNull final String description, @NotNull final String progressIndicatorText, final DomModelFactory factory, final Class<? extends LocalInspectionTool>... inspectionToolClasses) {
