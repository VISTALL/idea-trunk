...
public class StrutsValidator extends StrutsValidatorBase {
  ...
  public StrutsValidator(final StrutsProjectComponent component) {
    super("Struts Model validator", "Validating Struts model...", component.getStrutsFactory(), StrutsInspection.class);
  }
