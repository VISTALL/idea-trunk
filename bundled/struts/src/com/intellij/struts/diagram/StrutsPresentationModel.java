...
public class StrutsPresentationModel extends BasicGraphPresentationModel<StrutsObject, StrutsObject> {
  ...
  public boolean editNode(final StrutsObject strutsObject) {
    if (strutsObject.getPsiElement() instanceof Navigatable) {
      OpenSourceUtil.navigate(new Navigatable[] { (Navigatable)strutsObject.getPsiElement() }, true);
      return true;
    }
  ...
  // TODO ??
  public String getEdgeTooltip(final StrutsObject strutsObject) {
    return super.getEdgeTooltip(strutsObject);
  }

  public String getNodeTooltip(final StrutsObject strutsObject) {
