...
public class PsiBeanPropertyCache {
  ...
  public PsiBeanProperty[] getBeanProperties(@Nullable final PsiClass clazz) {
    ...
    final Set<PsiBeanProperty> props = new TreeSet<PsiBeanProperty>();
    for (PsiMethod method : methods) {
      ...
      if (name != null) {
        PsiField field = PropertyUtil.findPropertyField(clazz.getProject(), clazz, name, method.hasModifierProperty(PsiModifier.STATIC));
        if (field != null) {
