...
/**
 * Provides functionality for accessing DOM-Model of <code>validation.xml</code> files.
 */
public class ValidationModelImpl extends NamedModelImpl<FormValidation> implements ValidationModel {
  ...
  public List<Validator> getValidators() {
    ...
    for (Global global : globals) {
      ...
      final List<Validator> filteredValidators = ContainerUtil.findAll(validators, new Condition<Validator>() {
        public boolean value(final Validator validator) {
