...
public class TilesDomFactory extends StrutsPluginDomFactory<TilesDefinitions, TilesModel> {
  ...
  public List<TilesModel> computeAllModels(@NotNull Module module) {
    ArrayList<TilesModel> models = new ArrayList<TilesModel>(super.computeAllModels(module));
    TilesModelProvider[] providers = Extensions.getExtensions(TilesModelProvider.EP_NAME);
    for (TilesModelProvider provider : providers) {
