...
public class MultiDomTreeStructure<T extends DomElement, M extends NamedDomModel<T>> extends SimpleTreeStructure {
  ...
  private final SimpleNode myRoot = new SimpleNode() {
    ...
    public SimpleNode[] getChildren() {
      ...
      final ArrayList<Module> webModules = new ArrayList<Module>();
      ...
      return children.size() == 1 ? children.get(0).getChildren() : children.toArray(new SimpleNode[children.size()]);
    }
  ...
  private final static Icon WEB_MODULE_ICON = JavaeeIcons.WEB_MODULE_SMALL;
  private final static Icon STRUTS_MODULE_ICON = StrutsIcons.getIcon("StrutsModule.png");
  ...
  private class WebModuleNode extends SimpleNode {
    ...
    WebModuleNode(final Module module) {
      myModule = module;
      setUniformIcon(WEB_MODULE_ICON);
  ...
  private class ModelNode extends SimpleNode {
    ...
    ModelNode(M model) {
      myModel = model;
      setUniformIcon(STRUTS_MODULE_ICON);
