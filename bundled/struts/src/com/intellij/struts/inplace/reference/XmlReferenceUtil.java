...
public class XmlReferenceUtil {
   ...
   * @return Enclosing tag with the given name or <code>null</null> if none found.
   */
  @Nullable
   ...
   * @return Enclosing tag with the given attributes or <code>null</null> if none found.
   */
  @Nullable
