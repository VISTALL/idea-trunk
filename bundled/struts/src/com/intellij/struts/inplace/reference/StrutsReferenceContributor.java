...
public class StrutsReferenceContributor extends PsiReferenceContributor {
  ...
  public void registerReferenceProviders(final PsiReferenceRegistrar psiReferenceRegistrar) {
  ...
  private void registerCodeReferences(final PsiReferenceRegistrar registrar) {
  ...
  private void registerStrutsConfigReferences(final PsiReferenceRegistrar registrar) {
    ...
    ReferenceProviderUtils.registerTags(registrar, new ResourceBundleReferenceProvider() {
  ...
  private void registerWebAppReferences(final PsiReferenceRegistrar registrar) {
  ...
  private void registerJspReferences(final PsiReferenceRegistrar registrar) {
    ...
    ReferenceProviderUtils.registerTags(registrar, new PsiReferenceProvider() {
      ...
      public PsiReference[] getReferencesByElement(@NotNull final PsiElement psiElement,
        ...
        final JavaClassReferenceProvider classReferenceProvider = new JavaClassReferenceProvider(psiElement.getProject());
