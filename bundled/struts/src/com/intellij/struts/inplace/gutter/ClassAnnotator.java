...
abstract class ClassAnnotator {
   ...
   *
   * @return <code>true</code> if the current class was suitable for this Annotator, <code>false</code> otherwise.
   *
   ...
   * @return All navigation targets or <code>null</code> if none available.
   * @see GotoDeclGutter
   */
  @Nullable
