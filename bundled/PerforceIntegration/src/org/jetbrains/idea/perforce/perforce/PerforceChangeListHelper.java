...
public class PerforceChangeListHelper {
  ...
  public static String createSpecification(final String description, final long changeListNumber, @Nullable final List<String> files, final String clientName,
                                           final String userName,
                                           final boolean forUpdate) throws VcsException {
