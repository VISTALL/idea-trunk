...
public class SpecificationParser {
  ...
  public PerforceJobSpecification parse() throws VcsException {
    final List<PerforceJobField> fields = new ArrayList<PerforceJobField>();
  ...
  private boolean fieldsFinished(final String line) {
    return line.trim().startsWith("Values:");
  }

  private boolean fieldsStarted(final String line) {
    return line.trim().startsWith("Fields:");
  }

  private PerforceJobField parseField(final String line) throws VcsException {
