...
@NonNls public class P4OutputParserTest extends TestCase {
  ...
  public void testResolve() throws Exception{
    final Map<File, BaseRevision> output = PerforceRunner
    ...
    assertEquals(13, output.get(new File("C:\\work\\Irida\\source\\com\\intellij\\ide\\favoritesTreeView\\FavoritesTreeStructure.java")).getRevisionNum());
    assertEquals("//IDEA/source/com/intellij/ide/favoritesTreeView/FavoritesTreeStructure.java", output.get(new File("C:\\work\\Irida\\source\\com\\intellij\\ide\\favoritesTreeView\\FavoritesTreeStructure.java")).getDepotPath());

    assertEquals(8, output.get(new File("C:\\work\\Irida\\source\\com\\intellij\\ide\\ui\\customization\\CustomizableActionsPanel.java")).getRevisionNum());
    assertEquals("//IDEA/source/com/intellij/ide/ui/customization/CustomizableActionsPanel.java", output.get(new File("C:\\work\\Irida\\source\\com\\intellij\\ide\\ui\\customization\\CustomizableActionsPanel.java")).getDepotPath());
  }
  ...
  public void testReadChangeDescription() throws Exception{
  ...
  public void testResolved() throws Exception {
    ...
    final List<ResolvedFile> list = PerforceOutputMessageParser.processResolvedOutput(resolved, new Convertor<String, String>() {
